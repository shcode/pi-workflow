...
**MANDATORY**: Call `questionnaire` tool with all questions for the stage. Do NOT write files, do NOT answer yourself, do NOT use `ask_user_question`.
...
questionnaire({
  questions: [
    ...
    },
    {
      ...
      options: [
        { value: "dashboard", label: "Dashboard", description: "Analytics dashboard" },
        { value: "export", label: "Export", description: "CSV/PDF export" }
      ],
      multiSelect: true,
      allowOther: true
    }
